...
import { getBelegeSalesFormCopy, getBelegeSalesTableCopy } from "@/content/belege-module";
...
import { BelegeQuoteCreateDialog } from "./belege-quote-editor";

type BelegeSalesListProps = {
  locale: Locale;
...
export function BelegeSalesList({ locale, mode }: BelegeSalesListProps) {
