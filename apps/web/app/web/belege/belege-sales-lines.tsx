...
type BelegeSalesLinesSectionProps = {
  locale: Locale;
...
export function BelegeSalesLinesSection({
  locale,
  mode,
  documentId,
  lines,
  onDocumentUpdated,
}: BelegeSalesLinesSectionProps) {
  const lc = getBelegeSalesLinesCopy(locale);
...
type LineAddCopy = ReturnType<typeof getBelegeSalesLinesCopy>;
type FormCopy = ReturnType<typeof getBelegeSalesFormCopy>;

type BelegeSalesLineRowProps = {
...
type BelegeSalesLineAddDialogProps = {
  open: boolean;
...
function BelegeSalesLineAddDialog({
  open,
  onOpenChange,
  locale,
  lc,
  onSubmit,
}: BelegeSalesLineAddDialogProps) {
  const fc = getBelegeSalesFormCopy(locale);
